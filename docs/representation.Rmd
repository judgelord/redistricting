...
flow <- read_csv(here::here("data", "WI_DistrictFlows_January_2020.csv")) %>% mutate(state = "wisconsin") %>% 
  full_join(read_csv(here::here("data", "TX_DistrictFlows_January_2020.csv")) %>% mutate(state = "texas"))
...
d2 <- d %>% 
  left_join(within %>% mutate(district_code = to) ) %>% 
